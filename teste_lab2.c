...
struct BITMAPFILEHEADER{
	...
	unsigned long h_offsetbits;//off set bits

	unsigned long i_size;//bitmap size
	unsigned long i_width;//width of bitmap
	unsigned long i_height;//hight of bitmap
